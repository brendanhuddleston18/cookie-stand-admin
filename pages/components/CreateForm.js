...
export default function CreateForm(props) {
    ...
    return (
      ...
      className="flex flex-col w-2/3 gap-2 p-4 mx-auto bg-purple-400 border-purple-500 rounded-lg" >
      ...
      <div className="flex gap-2 text-center item-centereduce">
          ...
          <button type="submit" className="flex-1 min-w-0 bg-purple-500">Create</button>
      </div>
